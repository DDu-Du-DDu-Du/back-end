...
import com.modoo.application.common.dto.todo.TodoForTimetable;
...
class GetDailyTodosByTimeServiceTest {
  ...
  @Test
  void 주어진_날짜에_자신의_시간별_투두_리스트_조회를_성공한다() {
    // given
  ...
  @Test
  void 미룬_투두_시간표_조회시_미루기_일시를_포함한다() {
    // given
    Goal goal = saveGoalPort.save(GoalFixture.createRandomGoalWithUserAndPrivacyType(
        user.getId(),
        PrivacyType.PRIVATE
  ...
  @Test
  void 다른_사용자의_시간별_투두_리스트를_조회할_경우_전체공개_목표의_투두만_조회한다() {
    // given
