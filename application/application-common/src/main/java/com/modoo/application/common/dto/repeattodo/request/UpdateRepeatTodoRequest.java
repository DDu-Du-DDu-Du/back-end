package com.modoo.application.common.dto.repeattodo.request;

import com.modoo.domain.planning.repeattodo.dto.UpdateRepeatTodoCommand;
...
@Schema(description = "반복 투두 수정 요청")
public record UpdateRepeatTodoRequest(
    @Schema(
        name = "name",
        description = "반복 투두명",
        example = "물 한 컵 마시기"
  ...
  public UpdateRepeatTodoCommand toCommand() {
    return UpdateRepeatTodoCommand.builder()
        .beginAt(beginAt)
        .endAt(endAt)
        .endDate(endDate)
