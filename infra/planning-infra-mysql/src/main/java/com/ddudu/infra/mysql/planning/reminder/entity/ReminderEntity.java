package com.ddudu.infra.mysql.planning.reminder.entity;
...
public class ReminderEntity extends BaseEntity {
  ...
  @Column(name = "reminds_at", nullable = false, columnDefinition = "TIMESTAMP")
  private LocalDateTime remindsAt;

  @Column(name = "reminded_at", columnDefinition = "TIMESTAMP")
