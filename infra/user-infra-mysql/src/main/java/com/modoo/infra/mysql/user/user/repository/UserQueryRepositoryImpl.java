...
import static com.modoo.infra.mysql.user.user.entity.QAuthProviderEntity.authProviderEntity;
import static com.modoo.infra.mysql.user.user.entity.QUserEntity.userEntity;
