package com.modoo.infra.mysql.user.user.adapter;
...
import com.modoo.infra.mysql.user.user.dto.FullUser;
import com.modoo.infra.mysql.user.user.entity.AuthProviderEntity;
import com.modoo.infra.mysql.user.user.entity.UserEntity;
import com.modoo.infra.mysql.user.user.repository.AuthProviderRepository;
import com.modoo.infra.mysql.user.user.repository.UserRepository;
