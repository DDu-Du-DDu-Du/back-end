package com.ddudu.infrastructure.usermysql.user.adapter;
...
import com.ddudu.infrastructure.usermysql.user.repository.AuthProviderRepository;
import com.ddudu.infrastructure.usermysql.user.repository.UserRepository;
