package com.modoo.api.notification.inbox.doc;
...
import com.modoo.bootstrap.common.doc.examples.NotificationInboxErrorExamples;
...
public interface NotificationInboxControllerDoc {
  ...
  @Operation(summary = "알림 인박스 상태 조회")
  @ApiResponses(
      value = {
          @ApiResponse(
              responseCode = "200",
  ...
  ResponseEntity<NotificationInboxStatusResponse> getStatus(Long loginId);
